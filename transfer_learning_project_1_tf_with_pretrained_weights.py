# -*- coding: utf-8 -*-
"""Transfer Learning Project 1 - TF with pretrained weights.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/12-XpY2X7BLZxMlb2HQml22Q-w7oHrTJ4
...
Sample_Image= tf.keras.preprocessing.image.load_img(r'/content/drive/My Drive/Colab Notebooks/TF 2.0 Advanced/Transfer Learning Data/African_Elephant.jpg', target_size = (224, 224))

Sample_Image= tf.keras.preprocessing.image.load_img(r'/content/drive/My Drive/Colab Notebooks/TF 2.0 Advanced/Transfer Learning Data/bicycle.png', target_size = (224, 224))
...
Sample_Image= tf.keras.preprocessing.image.load_img(r'/content/drive/My Drive/Colab Notebooks/TF 2.0 Advanced/Transfer Learning Data/cat.282.jpg', target_size = (224, 224))

Sample_Image= tf.keras.preprocessing.image.load_img(r'/content/drive/My Drive/Colab Notebooks/TF 2.0 Advanced/Transfer Learning Data/dog.309.jpg', target_size = (224, 224))
